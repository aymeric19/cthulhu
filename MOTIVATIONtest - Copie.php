...
<!--entete avec feuille de style, titre, encodage -->
 ...
 <body>
  ...
  <h1>Bienvenue <?php echo $_SERVER['REMOTE_ADDR'];?> </h1>
	...
	<?php
  // test BD
  $servername = 'aymeric.herchuelz.sql.free.fr';
$username = 'aymeric.herchuelz';
$password = '';
...
// formulaire qui renvoie pseudo et password a la page .php
			...
			{
				echo '
				<form method="post" action="MOTIVATIONtest.php">
				<fieldset>
...
<h3>Bienvenue <?php echo $_POST['pseudo'];?> </h3>
        ...
        <!-- header end -->
		<img alt="wordpress" src="bande.jpg"/>
        ...
        ?>
              ...
              <p>  <FONT size="5pt"> Je me presente je m'appelle <strong>Herchuelz Aymeric</strong><br>
...
<!-- Un bouton avec '+' dedans, et un onclick qui appelle une fonction avec -->
<!-- en param le bouton et l'id du div à afficher/masquer. -->
<button type="button" onclick="toggle_div(this,'id_du_div');">ENGLISH</button>

<!-- Un div caché avec un attribut id -->
<div id="id_du_div" style="display:none;">
<p class="quote"><p><FONT size = "5pt"> Let me introduce myself, my name is <strong> Herchuelz Aymeric </strong> <br>
...
<br/> <h2>Citation</h2>
<br/>Men have created cemeteries in order to fix themselves in time and, despite the decomposition in space. »<br/>
By Emile Marcel / The Shadow and the Silence"
</FONT> </p>
  </div>
</div>
...
function toggle_div(bouton, id) { // On déclare la fonction toggle_div qui prend en param le bouton et un id
 var div = document.getElementById(id); // On récupère le div ciblé grâce à l'id
  if(div.style.display=="none") { // Si le div est masqué...
   ...
   bouton.innerHTML = "ENGLISH"; // ... et on change le contenu du bouton.
  }
}
</script>
       ...
       <div class="section">
        ...
        FLECHE
			...
			<?php } // fin premier else (si connecter)  ?>
    </body>
</html>
